...
import DiamondSpacifications from "./diamondsettings-element/DiamondSpacifications";
...
const DiamondSettingDetails = () => {
  ...
  const handleBackButton = (e) => {
    ...
    console.log(diamondType)
    if(diamondType === 'mined'){
      navigate("/apps/diamondtools");
    }

    if(diamondType === 'labcreated'){
      navigate("/apps/diamondtools/navlabgrown");
    }
    
    if(diamondType === 'fancydiamonds'){
      navigate("/apps/diamondtools/navfancycolored");
    }
  ...
  if (skeltonLoad == false) {
    ...
    return (
      <>
        ...
        <style>
          {`
          .gf-product-info .gf-product-controller ul li span{
            color: ${window.initData["data"][0].link_colour};
          }
          .gf-product-info .gf-product-controller ul li span:hover{
            color: ${window.initData["data"][0].link_colour};
        }
        .gf-product-info .gf-product-controller ul li span svg{
        ...
        //    color:${window.initData["data"][0].link_colour};
        // }
        .Diamond-form form .prefrence-action .gf-btn{
          background-color:${window.initData["data"][0].link_colour};
        }
        .Diamond-form form .prefrence-action .gf-btn:hover{
       ...
       .Diamond-form--small form .prefrence-action .preference-btn{
        background-color:${window.initData["data"][0].link_colour}; 
       }
       .Diamond-form--small form .prefrence-action .preference-btn:hover{
        background-color:${window.initData["data"][0].link_colour} !important; 
       }
        ...
        .range-slider_diamond .noUi-connect , .range-slider_diamond .noUi-horizontal .noUi-handle{
            ...
            .gf-diamond-change-view ul li.gf-active a.gf-grid-view-four svg{
              fill: ${window.initData["data"][0].hover_colour};
            }
            .gf-diamond-change-view ul .list-view.gf-active svg{
              fill: ${window.initData["data"][0].hover_colour};
            }
            ...
            .gf-product-info__title h4.gf-ring-spacifacation a{
              color:${window.initData["data"][0].link_colour};
            }
            ...
            .gf-diamond-change-view ul li a.gf-grid-view-four svg{
              fill:${window.initData["data"][0].link_colour};
            }
            .gf-diamond-change-view ul li:hover a.gf-grid-view-four{
              background-color:${window.initData["data"][0].link_colour};
              color:${window.initData["data"][0].button_colour};
            }
            .gf-diamond-change-view ul li:hover a.gf-grid-view-four svg{
              fill:${window.initData["data"][0].button_colour};
            }
             
            .gf-product-info__detail{
              background-color:${window.initData["data"][0].header_colour};
            }
            .gf-product-info__title h2 , .gf-ring-price span ,.gf-diamond-intro-field ul li p{
              color: ${window.initData["data"][0].link_colour};
            }
            .gf-product-info .gf-diamond-tryon .gf-cart-btns{
              background-color:${window.initData["data"][0].slider_colour};
              color: ${window.initData["data"][0].link_colour};
              outline-color: ${window.initData["data"][0].slider_colour};
            }
            .gf-product-info .gf-diamond-tryon .gf-cart-btns:hover{
              background-color:${window.initData["data"][0].link_colour} !important;
              color: ${window.initData["data"][0].slider_colour};
              outline-color: ${window.initData["data"][0].link_colour};
            }
            `}
        </style>
        <div className="gf-tool-container gf-details_product_container">
        ...
        <div className="Diamond_Spacifications">

          <DiamondSpacifications />
        </div>
        <div className="gf-detail-page-pro-lists">
