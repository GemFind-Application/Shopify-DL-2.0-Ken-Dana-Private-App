...
const DiamondProductGallary = (props) => {
  ...
  useEffect(() => {
    ...
    if (window.initData.data[0].showDefaultDiamondImage === "0") {
  ...
  return (
    <>
      <div className="product-image-gallary">
        <div className="gf_product_thumb_left_row">
        ...
        <div className={`ring-diamond-image-dia ${getImage === true ? "gf-active" : ""}`}>
        ...
        <div className={`ring-diamond-video ${getVideo === true ? "gf-active" : ""} `}
        >
