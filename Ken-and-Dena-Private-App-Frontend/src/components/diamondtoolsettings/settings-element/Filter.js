    ...
    <>
      <style>
        ...
        .gf-diamond-filter .gf-navigation_filter_left .n_filter_left li.gf-active a {
          ...
          .gf-diamond-filter .gf-navigation_filter_left .n_filter_left li a ,  .gf-diamond-filter .gf-navigation_filter_left .n_filter_left li span i {
            color: ${window.initData["data"][0].link_colour};
          }
          ...
          .gf-diamond-filter .gf-navigation_filter_left .n_filter_left li:hover{
            ...
            .gf-diamond-filter.gf-compare .gf-navigation_filter_left .n_filter_left li.gf-active{
              background-color:${window.initData["data"][0].hover_colour}; 
            ...
            .gf-diamond-filter .gf-save-reset-filter .gf-navigation_right li a:hover , .gf-diamond-filter .gf-save-reset-filter .gf-navigation_right li a{
              color: ${window.initData["data"][0].link_colour};
            }
            .gf-diamond-filter .gf-save-reset-filter .gf-navigation_right li a:hover svg , .gf-diamond-filter .gf-save-reset-filter .gf-navigation_right li a svg ,.gf-diamond-filter .gf-save-reset-filter .gf-navigation_right li a svg path{
            ...
            .gf-compareitems table tbody tr:nth-child(odd){
              background-color:${window.initData["data"][0].header_colour}; 
             }
             .gf-compareitems table tbody tr:nth-child:nth-child(even){
              background-color:${window.initData["data"][0].hover_colour}; 
             }
             .gf-compareitems table tbody tr th ,  .gf-compareitems table tbody tr td ,  .gf-compareitems table thead tr td{
              border-top: none;
              border-bottom: none;
              height: 30px;
              border-left: 1px solid #ddd;
             }
             .gf-compareitems thead tr th{
              border-bottom: none;
              border-left: 1px solid #ddd;
             }
             .gf-compareitems table thead tr td.compare_icons{
              text-align: center;
             }
             .gf-compareitems table thead tr td{
              height: 40px;
             
             }
             .gf-compareitems table thead tr td.compare_icons a{
              color:${window.initData["data"][0].link_colour};
              margin: 0 6px;
              font-size: 16px;
             }
...
<path d="M18 18L18 19.5L6 19.5L6 18L18 18Z" fill="#080341"/>
          ...
          {getcomparesetting !== "" && getcomparesetting !== null && (
            <li className={`mobile_compare ${getTab === "compare" ? "gf-active" : ""}`}>
              <a href="javascript:;" onClick={handletab} id="compare">
                {getcomparesetting}
              </a>
            </li>
