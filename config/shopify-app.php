...
return [
    ...
    */
    ...
    'appbridge_version' => env('SHOPIFY_APPBRIDGE_VERSION', '3.5.1'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'fc9193d288916d4762414302f122f75d'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'a768f1aa12c2cf651f84881943455196'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_products,write_inventory,read_locations,write_checkouts,read_themes'),
    /*
    |--------------------------------------------------------------------------
